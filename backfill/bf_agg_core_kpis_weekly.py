...
run_pipeline(table_name='agg_core_kpis_weekly', db_name='klup_production',query_params={'START_DATE':'2020-01-01','END_DATE':'2020-04-20','TIME_INTERVAL':'WEEK'})

run_pipeline(table_name='agg_core_kpis_monthly', db_name='klup_production',query_params={'START_DATE':'2020-01-01','END_DATE':'2020-04-20','TIME_INTERVAL':'MONTH'})
